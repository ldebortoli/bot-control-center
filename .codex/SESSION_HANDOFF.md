...
- Desde 2026-08-15 el visor de triggers pagina de a 10 y permite buscar por ID/nombre de chat, filtrar por tipo y rango de fechas, y ordenar por fecha, nombre o chat. La UI conserva el adaptador remoto existente y muestra estados vacios explicitos. La prueba de readiness es multiplataforma y no presupone que el runner Linux tenga PowerShell/GCloud instalados. Validacion local: lint, build y 48/48 pruebas, cobertura del agente 100% en lineas/ramas/funciones y audit de produccion en 0.
- El remoto de GitHub fue verificado como publico. Se agrego `.github/workflows/quality.yml` con una unica validacion rapida para `main`, cache de npm, cancelacion de ejecuciones reemplazadas y timeout de 15 minutos.
